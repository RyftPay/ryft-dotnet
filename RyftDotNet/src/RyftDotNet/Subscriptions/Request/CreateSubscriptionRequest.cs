...
namespace RyftDotNet.Subscriptions.Request
{
    public sealed class CreateSubscriptionRequest
    {
        ...
        public CreateSubscriptionCustomerRequest Customer { get; }

        [property: JsonPropertyName("price")]
        public CreateSubscriptionPriceRequest Price { get; }
        ...
        public CreateSubscriptionRequest(
            CreateSubscriptionCustomerRequest customer,
            CreateSubscriptionPriceRequest price)
        {
            Customer = customer;
            Price = price;
        }
